          ...
          <table className="min-w-full bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
              <tr>
                ...
                <th className="text-left text-gray-600 dark:text-gray-300 uppercase text-xs font-semibold p-4">Category</th>
                <th className="text-left text-gray-600 dark:text-gray-300 uppercase text-xs font-semibold p-4">Actions</th>
              </tr>
            </thead>
            <tbody>
              {wishlist?.length > 0 ? (
                wishlist.map((item, i) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-sm text-gray-500 dark:text-gray-400 capitalize">{item.category}</td>
                    <td className="p-4">
                      <div className="flex gap-2 flex-wrap">
                        ...
                        <button
                          className="bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-md shadow-md transition text-sm"
        ...
        <div className="md:hidden space-y-4">
          {wishlist?.length > 0 ? (
              ...
              <div key={i} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 border border-gray-200 dark:border-gray-700">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-gray-800 dark:text-white text-base mb-2 line-clamp-2">{item.title}</div>
                    <div className="space-y-1 text-sm">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-gray-600 dark:text-gray-300 capitalize">{item.category}</span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-2 mt-4">
                      ...
                      <button
                        className="bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-md shadow-md transition text-sm flex-1 sm:flex-none"
                        onClick={() => addToWishlist(item)}
                      >
                        Remove
                      </button>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center border border-gray-100 dark:border-gray-700">
              <div className="text-gray-500 dark:text-gray-400 text-lg mb-4">Your wishlist is empty</div>
              <Link
                to="/products"
